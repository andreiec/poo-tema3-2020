...
public:
    ...
    static void ap_incr_nr_loc(){
        static int numar_ap = 0;
        numar_ap++;
    }

    Apartament():Locuinta(){this->etaj=0;}
    Apartament(string nume,float sup_utila,float d,float pm2,int e):Locuinta(nume,sup_utila,d,pm2){
        this->etaj=e;
    }
...
public:
    ...
    static void casa_incr_nr_loc(){
        static int numar_case = 0;
        numar_case++;
    }
...
istream& Apartament::citire(istream& in) {
    ...
    try {
        ...
        if(this -> suprafata_utila <= 0)
            ...
            cout << "Suprafata utila trebuie sa fie un numar pozitiv!"<<endl;
            goto suprafatautila;
        }
    ...
    discountexceptie:
        try {
            ...
            cout << "Discountul trebuie sa fie un nr pozitiv mai mic decat 10!" << endl;
    ...
    pretpem2:
        try {
            ...
            cout << "Pretul pe metru patrat trebuie sa fie un numar pozitiv!" << endl;
            goto pretpem2;
        }
    ...
    etajexc:
        try {
            cout << "Etaj: ";
            in >> this -> etaj;
            if(this -> etaj < 0 || this -> etaj > 100)
                throw this -> etaj;
        }catch(int et) {
            cout << "Etajul trebuie sa fie un nr pozitiv mai mic decat 100!" << endl;
            goto etajexc;
        }
...
ostream& Apartament::afisare(ostream& out) const {
    out << "Apartament" << endl;
    out << "Numele clientului: " << this -> nume_client << endl << "Suprafata utila: " << this -> suprafata_utila << endl << "Discount: " << this -> discount << endl << "Pret pe metru patrat: " << this -> pretm2 << endl << "Etaj: " << this -> etaj << endl;
    out << "Chirie: " << this -> chirie << endl << endl;
    return out;
}
...
istream& Casa::citire(istream& in) {
    ...
    curteexc:
        try {
            ...
            cout << "Suprafata curtii trebuie sa fie un numar pozitiv!" << endl;
            goto curteexc;
        }
    ...
    pretm2curteexc:
        try {
            ...
            cout << "Pretul pe metru patrat de curte trebuie sa fie un numar pozitiv!" << endl;
            goto pretm2curteexc;
        }
    ...
    numaretajeexc:
        try {
            ...
            cout << "Numarul de etaje trebuie sa fie un numar pozitiv!" << endl;
            goto numaretajeexc;
        }
    ...
    suppeetexc:
        try {
            ...
            cout << "Suma suprafetelor pe etaje trebuie sa fie egale cu suprafata utila totala!"<<endl;
            goto suppeetexc;
        } catch(int x) {
            cout << "Suprafata pe etaj trebuie sa fie un nr pozitiv!";
            goto suppeetexc;
        }
...
ostream& Casa::afisare(ostream& out) const {
    out << "Casa" << endl;
    out << "Nume client: " << this -> nume_client << endl << "Suprafata utila: " << this -> suprafata_utila << endl << "Discount: " << this -> discount << endl << "Pret pe metru patrat: " << this -> pretm2 << endl << "Suprafata curte: " << this -> curte << endl << "Pret pe metru patrat curte: ";
    out << this -> pretm2curte << "Numar etaje: " << this -> nr_etaje;
...
Gestiune<T>::Gestiune(int nrl) {
    ...
    for(int i = 0; i < nrl; i++) {
        cout << "Introduceti datele locuintei " << i + 1 << " (A pentru Apartament si C pentru Casa)" << endl;
        cin >> opt;
        switch(opt) {
        case 'A':
            {
...
istream& operator>>(istream& in, Gestiune<T> & ob) {
    ...
    cout << "Introduceti numarul de locuinte: " << endl;
    ...
    for(int i = 0; i < nrl; i++) {
        cout << endl << "Introduceti datele locuintei " << i + 1 << ". (A pentru Apartament, C pentru casa)" << endl;
...
ostream& operator<<(ostream& out, const Gestiune<T>& ob) {
    out << "--------------------------------------" << endl << "Afisarea locuintelor din gestiune: " << endl << endl;
...
istream& operator>>(istream& in, Gestiune<char*>& ob) {
    ...
    for(int i = 0; i < nrl; i++) {
        cout << "Introduceti datele despre locuinta " << i + 1 << " (A pentru Apartament, C pentru Casa)" << endl;
        in >> opt;
        switch(opt) {
        case 'A':
            {
